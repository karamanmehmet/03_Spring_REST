...
@RestController
@RequestMapping("/clientBuilderDetail")
public class RESTClientControllerWebClientDetailed {
	...
	@Autowired
	public RESTClientControllerWebClientDetailed(
			@Qualifier("webClient-Builder-Detail") WebClient.Builder webClientBuilder) {
